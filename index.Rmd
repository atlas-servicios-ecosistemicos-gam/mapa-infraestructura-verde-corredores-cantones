---
title: "Mapa de infraestructura verde de los corredores biológicos interurbanos María Aguilar y Río Torres y de los cantones Curridabat, La Unión, Montes de Oca y San José"
output: 
...
raster_infraestructura_verde <-
  ...
  aggregate(fact=4, fun=modal) %>% # ¡¡HAY QUE TRATAR DE ELIMINAR ESTA AGRUPACIÓN. PODRÍA FUNCIONAR AL USAR MÁS MEMORIA LINUX!!
...
### Datos para descarga: [Capa geoespacial de infraestructura verde de los corredores biológicos interurbanos María Aguilar y Río Torres y de los cantones Curridabat, La Unión, Montes de Oca y San José](https://raw.githubusercontent.com/atlas-servicios-ecosistemicos-gam/datos/master/infraestructura-verde/corredores-cantones/IV_CORREDORES_CANTONES.TIF)
```{r}
